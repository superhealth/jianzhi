...
insert into `zt_attachement`(`att_id`,`att_name`,`att_type`,`att_size`,`att_mid`,`att_time`,`att_download`) values('15','53a30943ce124.jpg','jpg','28.46Kb','carl','1403193667','0');
insert into `zt_attachement`(`att_id`,`att_name`,`att_type`,`att_size`,`att_mid`,`att_time`,`att_download`) values('14','53a30943cdd3c.jpg','jpg','4.33Kb','carl','1403193667','0');
...
insert into `zt_duefee`(`due_id`,`due_discount`,`due_price`,`due_mid`,`due_createtime`,`due_operator`,`due_paystatus`,`due_paytime`,`due_backcode`) values('1','1','100.00','dapianzi','1403277145','carl','1','1403277145','');
insert into `zt_duefee`(`due_id`,`due_discount`,`due_price`,`due_mid`,`due_createtime`,`due_operator`,`due_paystatus`,`due_paytime`,`due_backcode`) values('2','2','100.00','oowoolf','1403352507','carl','1','1403352507','');
insert into `zt_duefee`(`due_id`,`due_discount`,`due_price`,`due_mid`,`due_createtime`,`due_operator`,`due_paystatus`,`due_paytime`,`due_backcode`) values('3','1','100.00','oowoolf','1403352528','carl','1','1403352528','');
...
insert into `zt_enumsort`(`es_id`,`es_name`,`es_order`,`es_sort_id`,`es_base`) values('9','平织','2','1','面料');
...
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('60','编辑','编辑会员[dahubi]的基本信息','carl','1403189383','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('61','编辑','编辑会员[dahubi]的基本信息','carl','1403189715','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('62','编辑','编辑企业会员[] 的信息。','carl','1403193350','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('63','编辑','编辑企业会员[] 的信息。','carl','1403193667','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('64','锁定','锁定用户：oowoolf','carl','1403276638','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('65','锁定','锁定用户：dapianzi,dahubi','carl','1403277037','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('66','解锁','解锁用户：oowoolf','carl','1403277122','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('67','解锁','解锁用户：dapianzi','carl','1403277127','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('68','解锁','解锁用户：dahubi','carl','1403277131','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('69','续费','会员<span class=\'blue\'>dapianzi</span> 续费 <strong class=\'yellow\'>1</strong>年；操作员：<span class=\'green\'>[carl]</span>. ','carl','1403277145','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('70','编辑','编辑会员[oowoolf]的基本信息','carl','1403352410','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('71','续费','会员<span class=\'blue\'>oowoolf</span> 续费 <strong class=\'yellow\'>2</strong>年；操作员：<span class=\'green\'>[carl]</span>. ','carl','1403352507','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('72','续费','会员<span class=\'blue\'>oowoolf</span> 续费 <strong class=\'yellow\'>1</strong>年；操作员：<span class=\'green\'>[carl]</span>. ','carl','1403352528','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('73','新增','添加新子类<strong>平织</strong>,属于 <i>服装</i> 下的 [面料]','carl','1403353067','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('74','编辑','修改生产属性【 制造生产】','carl','1403353136','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('75','新增','添加生产属性【 贸易销售】','carl','1403353155','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('76','新增','添加生产属性【 设计开发】','carl','1403353172','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('77','新增','添加生产属性【 系统工程】','carl','1403353200','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('78','新增','添加生产属性【 劳务人力】','carl','1403353223','127.0.0.1');
insert into `zt_log`(`log_id`,`log_action`,`log_detail`,`log_user`,`log_time`,`log_ip`) values('79','编辑','修改生产属性【 系统工程】','carl','1403353239','127.0.0.1');
...
insert into `zt_member`(`mem_id`,`mem_rank`,`mem_password`,`mem_email`,`mem_tel`,`mem_state`,`mem_logincount`,`mem_regtime`,`mem_type`,`mem_active`,`mem_expiretime`,`mem_varifycode`) values('oowoolf','10000','bab68d575e5e96461ad6ac2c975f9396','609164964@qq.com','13760432926','1','1','0','0','1','1497960507','sfasdfad');
insert into `zt_member`(`mem_id`,`mem_rank`,`mem_password`,`mem_email`,`mem_tel`,`mem_state`,`mem_logincount`,`mem_regtime`,`mem_type`,`mem_active`,`mem_expiretime`,`mem_varifycode`) values('dapianzi','9999','bab68d575e5e96461ad6ac2c975f9396','448379160@qq.com','15270694370','1','1','0','0','1','1434813145','{code:88888888,time:0}');
insert into `zt_member`(`mem_id`,`mem_rank`,`mem_password`,`mem_email`,`mem_tel`,`mem_state`,`mem_logincount`,`mem_regtime`,`mem_type`,`mem_active`,`mem_expiretime`,`mem_varifycode`) values('dahubi','5000','bab68d575e5e96461ad6ac2c975f9396','carl@chuango.com','13145816924','1','1','2014','1','1','1403366400','{code:88888888,time:0}');
...
insert into `zt_membercompany`(`mc_id`,`mc_mid`,`mc_company`,`mc_adress`,`mc_licence`,`mc_licencescan`,`mc_legal`,`mc_legalscan`,`mc_legalid`,`mc_status`,`mc_step`) values('1','dahubi','chuango','琼玉路8号','1245435','14','dapianzi','15','adfasdfa','0','1');
...
insert into `zt_memberperson`(`mp_id`,`mp_mid`,`mp_name`,`mp_identily`,`mp_idscanning`,`mp_sex`,`mp_adress`) values('1','oowoolf','','','0','1','');
insert into `zt_memberperson`(`mp_id`,`mp_mid`,`mp_name`,`mp_identily`,`mp_idscanning`,`mp_sex`,`mp_adress`) values('2','dapianzi','','','0','1','');
...
insert into `zt_property`(`pp_id`,`pp_name`,`pp_order`) values('3','制造生产','0');
insert into `zt_property`(`pp_id`,`pp_name`,`pp_order`) values('4','贸易销售','2');
insert into `zt_property`(`pp_id`,`pp_name`,`pp_order`) values('5','设计开发','3');
insert into `zt_property`(`pp_id`,`pp_name`,`pp_order`) values('6','系统工程','5');
insert into `zt_property`(`pp_id`,`pp_name`,`pp_order`) values('7','劳务人力','4');
