...
CREATE TABLE `zt_project` (
  ...
  `pro_subject` varchar(64) NOT NULL,
  `pro_description` text NOT NULL,
  `pro_attachement` varchar(64) DEFAULT '',
...
这项包含了反恐理论及实践的课程，主要用于培养在公安机关及其他政法机关相关部门从事预防、打击、处置恐怖主义工作的应用型高级专门人才。“恐怖主义形成原因复杂，如果不做深入了解和研究，很难真正做到‘反恐’。”一位专家在分析该专业时表示。','51,52,53,54','120.00','1403600672','热镀管','1403600672','1403600672','发-俺的沙啊','2','0','dasfas ','1','2433','3');
insert into `zt_project`(`pro_id`,`pro_sn`,`pro_sort`,`pro_mid`,`pro_enums`,`pro_prop`,`pro_subject`,`pro_description`,`pro_attachement`,`pro_deposit`,`pro_opentime`,`pro_place`,`pro_publishtime`,`pro_createtime`,`pro_startstop`,`pro_cover`,`pro_limit`,`pro_addition`,`pro_status`,`pro_view`,`pro_step`) values('2','FSAFGDASF','1','oowoolf','fgadfadf','0','第dr个项目','
这项包含了反恐理论及实践的课程，主要用于培养在公安机关及其他政法机关相关部门从事预防、打击、处置恐怖主义工作的应用型高级专门人才。“恐怖主义形成原因复杂，如果不做深入了解和研究，很难真正做到‘反恐’。”一位专家在分析该专业时表示。','3,4,5','120.00','1403600716','热镀管','1403600716','1403600716','发-俺的沙啊','2','0','dasfas ','1','2433','3');
...
insert into `zt_project`(`pro_id`,`pro_sn`,`pro_sort`,`pro_mid`,`pro_enums`,`pro_prop`,`pro_subject`,`pro_description`,`pro_attachement`,`pro_deposit`,`pro_opentime`,`pro_place`,`pro_publishtime`,`pro_createtime`,`pro_startstop`,`pro_cover`,`pro_limit`,`pro_addition`,`pro_status`,`pro_view`,`pro_step`) values('12','8KaxjS68','1','dahubi','','4','yJshcmCwULji1mER','kdSfB6BCFSKKPFxt34GaNoF3wpjdgXYo1HWXOV5SfhKDt5Md3Xw54Pb7o11gVXvaoYaT7','','746.00','','','1404200973','1403596925','','','0','','0','0','0');
insert into `zt_project`(`pro_id`,`pro_sn`,`pro_sort`,`pro_mid`,`pro_enums`,`pro_prop`,`pro_subject`,`pro_description`,`pro_attachement`,`pro_deposit`,`pro_opentime`,`pro_place`,`pro_publishtime`,`pro_createtime`,`pro_startstop`,`pro_cover`,`pro_limit`,`pro_addition`,`pro_status`,`pro_view`,`pro_step`) values('13','2I8kFtrg','4','dahubi','','2','djMkc3f5DDLiuIZm','gla7Va1SUdLuc87kgZge7m0v9nt3mDqdc7HLFb0lVW1e0Oc1EuS5Bkwv57VLi7pVEsyev','','509.00','','','1404205969','1403603329','','','0','','0','0','0');
insert into `zt_project`(`pro_id`,`pro_sn`,`pro_sort`,`pro_mid`,`pro_enums`,`pro_prop`,`pro_subject`,`pro_description`,`pro_attachement`,`pro_deposit`,`pro_opentime`,`pro_place`,`pro_publishtime`,`pro_createtime`,`pro_startstop`,`pro_cover`,`pro_limit`,`pro_addition`,`pro_status`,`pro_view`,`pro_step`) values('14','WJGILEZo','4','dahubi','','4','96wM1wDJAYRP0BZ3','PnS9QUdzoTDb2a3Ar6VSSvdD3LqYaGvrXDWcCrFNVtbk2yrpG2V86KA403UiBLQsCfSDgmY','','240.00','','','1404207566','1403600544','','','0','','0','0','0');
insert into `zt_project`(`pro_id`,`pro_sn`,`pro_sort`,`pro_mid`,`pro_enums`,`pro_prop`,`pro_subject`,`pro_description`,`pro_attachement`,`pro_deposit`,`pro_opentime`,`pro_place`,`pro_publishtime`,`pro_createtime`,`pro_startstop`,`pro_cover`,`pro_limit`,`pro_addition`,`pro_status`,`pro_view`,`pro_step`) values('15','GfeIgvdk','1','valerie','','5','P9aFnB1LKJiJ8j4b','eLHcgTem126OC2f6QddiTvU5taPtQ5V6GyG2ds4TbwKMr4cJI8kfMGM6ZcAqbFn1Iwd2pLL','','65.00','','','1404206587','1403604734','','','0','','0','0','0');
insert into `zt_project`(`pro_id`,`pro_sn`,`pro_sort`,`pro_mid`,`pro_enums`,`pro_prop`,`pro_subject`,`pro_description`,`pro_attachement`,`pro_deposit`,`pro_opentime`,`pro_place`,`pro_publishtime`,`pro_createtime`,`pro_startstop`,`pro_cover`,`pro_limit`,`pro_addition`,`pro_status`,`pro_view`,`pro_step`) values('16','R3OdKFuy','3','valerie','','4','pjRzas6UFg4ddfQI','Kl2w3JIqhw9MzwDqRhWJAYdwM6hRNgsOFXN7NuZILEm7FDPd8aGBcsL9veqk9IxFBp4d','','741.00','','','1404202875','1403603182','','','0','','0','0','0');
