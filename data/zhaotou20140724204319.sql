...
insert into `zt_cronhash`(`ch_name`,`ch_time`) values('member','1406205646');
...
insert into `zt_duefee`(`due_id`,`due_discount`,`due_price`,`due_mid`,`due_createtime`,`due_operator`,`due_paystatus`,`due_paytime`,`due_backcode`,`due_remark`,`due_log`) values('','1','100.00','oowoolf','1406114827','carl','1','1406114827','','招商银行','');
insert into `zt_duefee`(`due_id`,`due_discount`,`due_price`,`due_mid`,`due_createtime`,`due_operator`,`due_paystatus`,`due_paytime`,`due_backcode`,`due_remark`,`due_log`) values('NF53CF9F1AA0DF','2','100.00','oowoolf','1406115610','carl','1','1406115610','','','');
...
insert into `zt_member`(`mem_id`,`mem_rank`,`mem_password`,`mem_email`,`mem_tel`,`mem_state`,`mem_logincount`,`mem_regtime`,`mem_type`,`mem_active`,`mem_expiretime`,`mem_verifycode`) values('oowoolf','10000','eb2de2dbb6208350c7dab108bb3c3d6e','609164964@qq.com','13760432926','1','7','0','0','1','1500722827','14VD4M6-1406205533');
insert into `zt_member`(`mem_id`,`mem_rank`,`mem_password`,`mem_email`,`mem_tel`,`mem_state`,`mem_logincount`,`mem_regtime`,`mem_type`,`mem_active`,`mem_expiretime`,`mem_verifycode`) values('dapianzi','9999','bab68d575e5e96461ad6ac2c975f9396','448379160@qq.com','15270694370','1','6','0','0','1','1406736000','ASTOE9ZN-1406204727');
...
insert into `zt_member`(`mem_id`,`mem_rank`,`mem_password`,`mem_email`,`mem_tel`,`mem_state`,`mem_logincount`,`mem_regtime`,`mem_type`,`mem_active`,`mem_expiretime`,`mem_verifycode`) values('luren','0','bab68d575e5e96461ad6ac2c975f9396','oowoolf@gmail.com','','0','0','1405573944','0','1','1408165944','TLJZBACL-1406204928');
...
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('1','【系统消息】啦啦啦啦啦','a嘎达发噶啊地方噶阿迪发送的','0','0','','');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('2','【系统消息】啦啦啦啦啦','a嘎达发噶啊地方噶阿迪发送的','0','0','','');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('3','【系统消息】 会员年费续费提醒','您的会员有效时间已不足30天，请及时续费以继续使用我们的服务，谢谢！','1405044635','0','','dapianzi');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('4','【系统消息】 会员年费续费提醒','您的会员有效时间已不足30天，请及时续费以继续使用我们的服务，谢谢！','1405044670','0','','dapianzi');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('5','【系统消息】 会员年费续费提醒','您的会员有效时间已不足30天，请及时续费以继续使用我们的服务，谢谢！','1405047462','0','','安防');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('6','[系统消息] 实名认证审核结果','很遗憾，您所提交的实名认证资料未能通过审核。<br />原因：','1405595583','0','','dapianzi');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('7','【系统消息】 实名认证审核结果','恭喜您通过了实名认证程序！','1405595998','0','','dapianzi');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('8','【系统消息】 实名认证审核结果','很遗憾，您所提交的实名认证资料未能通过审核。<br />原因：没有手机号','1405596060','0','','oowoolf');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('9','【系统消息】 实名认证审核结果','很遗憾，您所提交的实名认证资料未能通过审核。<br />原因：没有扫描件','1405596167','0','','dahubi');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('10','【系统消息】 实名认证审核结果','很遗憾，您所提交的实名认证资料未能通过审核。<br />原因：不合格','1405598663','0','','王路飞');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('11','银行转账续费成功通知','恭喜您已通过银行转账成功续费，会员到期时间变更为1970年01月01日。感谢您对《订单网》的支持！','1406114827','0','账户消息','oowoolf');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('12','银行转账续费成功通知','恭喜您已通过银行转账成功续费，会员到期时间变更为2017年07月22日。感谢您对《订单网》的支持！','1406115610','0','账户消息','oowoolf');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('13','年费过期提醒','Array 您好，您的会员将于2017年07月22日到期。请及时续费以继续使用《订单网》的服务，点此<a href=\"/Due\">立即续费</a>。','1406205725','0','账户消息','');
insert into `zt_notice`(`no_id`,`no_subject`,`no_content`,`no_time`,`no_read`,`no_type`,`no_mid`) values('14','年费过期提醒','Array 您好，您的会员将于2017年07月22日到期。请及时续费以继续使用《订单网》的服务，点此<a href=\"/Due\">立即续费</a>。','1406205728','0','账户消息','');
