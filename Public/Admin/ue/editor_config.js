...
(function () {
	...
	//测试路径
	//URL = "/bootAdmin/Public/Admin/ue/";
	//实际路径
    URL = "/Public/Admin/ue/";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //屏幕截图配置区
        ,snapscreenHost: 'www.chuango.com'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ...
        ,initialStyle:'body{font-size:13px}'   //编辑器内部样式,可以用来改变字体等
